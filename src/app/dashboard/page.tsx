          ...
          <div className="relative rounded-2xl border border-gold-500/30 bg-gold-500/5 overflow-hidden p-6 flex items-center gap-5">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-slate-400">
                Add your branch, MOS, and separation date to unlock tailored benefit recommendations.
              </p>
            </div>
            <Link
              href="/onboarding"
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <ActionCard
              ...
              description="AI-powered guidance to file stronger VA claims and maximize your rating."
              cta="Start Claim"
            />
            <ActionCard
        ...
        {tier === 'free' && (
          <section className="rounded-2xl border border-white/[0.07] bg-white/[0.02] p-6 flex items-center gap-6">
            <div className="flex-1">
              ...
              <p className="text-sm text-slate-400">
                Unlimited VA eligibility checks, Claims Copilot, document upload, and career toolkit.
              </p>
            </div>
            <Link
